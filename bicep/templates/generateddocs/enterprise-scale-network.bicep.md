...
Implementation of the Enterprise Scale Network Topology
...
```json
{
    ...
    "metadata": {
        "template": "bicep/templates/enterprise-scale-network.json"
    },
    "parameters": {
        "parAzFirewallAvailabilityZones": {
            "value": []
        ...
        "parResourceGroups": {
            "value": [
                {
                    "parName": "[format('{0}-connectivity', parameters('parPrefix'))]",
                    "parLocation": "westeurope",
                    "parTags": "[parameters('parTags')]"
                },
                {
                    "parName": "[format('{0}-connectivity-westeurope', parameters('parPrefix'))]",
                    "parLocation": "westeurope",
                    "parTags": "[parameters('parTags')]"
                }
            ]
